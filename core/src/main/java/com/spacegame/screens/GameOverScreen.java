...
public class GameOverScreen implements Screen {
    ...
    public void render (float delta) {
        ...
        game.batch.draw(gameOverBanner, (float) SpaceGame.WIDTH / 2 - (float) BANNER_WIDTH / 2, SpaceGame.HEIGHT - BANNER_HEIGHT - 15, BANNER_WIDTH, BANNER_HEIGHT);
        ...
        float mainMenuX = (float) SpaceGame.WIDTH / 2 - mainMenuLayout.width /2;
        float mainMenuY = (float) SpaceGame.HEIGHT / 2 - mainMenuLayout.height / 2 - tryAgainLayout.height - 15;
